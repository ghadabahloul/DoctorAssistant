...
import database.RendezVous;
import database.databasehelper;


public class MakeRendezVous extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.makerendervous);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.conform_appo)
        {
            ...
            Toast temp;
            temp = Toast.makeText(MakeRendezVous.this, "Appointment successfull!", Toast.LENGTH_SHORT);
            temp.show();
