...
public class ModifRendezVous extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifrendezvous);
...
*/
                ...
                //   @Override
                //    public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(ModifRendezVous.this);
                ...
                a_builder.setMessage("The Patient is not present, Do you want to add ??")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(getApplicationContext(), AjoutPatient.class);
                                startActivity(i);
        ...
        if (v.getId() == R.id.conform_appo) {
            ...
            Toast temp;
            temp = Toast.makeText(ModifRendezVous.this, "Info Updated", Toast.LENGTH_SHORT);
            temp.show();
        ...
        if (v.getId() == R.id.apphome) {
            ...
            Intent i = new Intent(getApplicationContext(), Mainpage_RendezVous.class);
            startActivity(i);
