...
public class homepage extends Activity implements View.OnClickListener {
   ...
   Button b1, b2, b3, b4, b5, b6;
    ...
    public void onClick(View v) {
        ...
        {
            Intent i = new Intent(homepage.this, AjoutPatient.class);
            startActivity(i);
        }

        if(v.getId()==R.id.btn_appointment)
        {
            Intent i = new Intent(homepage.this, Mainpage_RendezVous.class);
            startActivity(i);
        }

        if(v.getId()==R.id.button5)
        {
            Intent i = new Intent(homepage.this, Facturation.class);
            startActivity(i);
        }
