...
// colone du utilisateur
   ...
   // private static final String DATABASE_NAME = "patientinfo.db";
    ...
    //rendezvous database app_id ,app_name, app_reason, app_contact, app_date;
...
//facturation  table
   ...
   private static final String TABLE_C = "create table patientinfo" + "(pid integer primary key AUTOINCREMENT not null ,"+
    ...
    public void insert(Utilisateur c){
...
//app_id ,app_name, app_reason, app_contact, app_date;
   ...
   public void insert2(Patient c1){
    ...
    public void insert3(RendezVous c2){
...
//billing
    ...
    public void insert4(Facturation c4){
